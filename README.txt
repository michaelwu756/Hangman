...
game into a file called dictionary.txt and a cheat mode that restarts the game with
one guess remaining. I used the logging mode to generate the dictionary included
in this project. There is also a verbose option that shows how the program
decides the next letter to guess. Type in 'help' when the program starts for
more information.
